...
void GLCD_Init (void) {
  ...
  PIOA->PIO_WPMR = PIO_WPDIS_KEY;               /* Disable write protection   */
  PIOB->PIO_WPMR = PIO_WPDIS_KEY;               /* Disable write protection   */
  PIOC->PIO_WPMR = PIO_WPDIS_KEY;               /* Disable write protection   */
...
/*--------------------------- CS2 --------------------------------------------*/
  ...
  PIOC->PIO_WPMR = PMC_WPEN_KEY;                /* Enable write protection    */
  PIOB->PIO_WPMR = PMC_WPEN_KEY;                /* Enable write protection    */
  PIOA->PIO_WPMR = PMC_WPEN_KEY;                /* Enable write protection    */
