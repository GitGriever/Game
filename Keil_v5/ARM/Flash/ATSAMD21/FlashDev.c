 ...
 * $Revision:    V1.00
 *  
 * Project:      Flash Device Description for ATSAMD21
 * --------------------------------------------------------------------------- */
...
struct FlashDevice const FlashDevice  =  {
   ...
   "ATSAMD21 256kB Flash",      // Device Name
   ONCHIP,                      // Device Type
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,              // Driver Version, do not modify!
   "ATSAMD21 128kB Flash",      // Device Name
   ONCHIP,                      // Device Type
   0x00000000,                  // Device Start Address
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,              // Driver Version, do not modify!
   "ATSAMD21 64kB Flash",       // Device Name
   ONCHIP,                      // Device Type
   0x00000000,                  // Device Start Address
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,              // Driver Version, do not modify!
   "ATSAMD21 32kB Flash",       // Device Name
   ONCHIP,                      // Device Type
   0x00000000,                  // Device Start Address
