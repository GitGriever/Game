...
static const char intro[] =
  "\n\n\n\n\n\n\n\n"
  "+-----------------------------------------------------------------------+\n"
  "|                NAND Flash File Manipulation example                   |\n";
...
static void init_display () {
  ...
  GLCD_DisplayString (1, 0, __FI, "   Atmel SAM4S-EK   ");
  GLCD_DisplayString (2, 0, __FI, "  Evaluation Board  ");
  GLCD_DisplayString (4, 0, __FI, "       RL-ARM       ");
  GLCD_DisplayString (5, 0, __FI, " NAND_File example  ");
}
