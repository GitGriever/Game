...
**
**     Reference manual:    K60P144M100SF2V2RM Rev. 1, Jan 2012
...
/* Predefined clock setups
   ...
   3 ... Multipurpose Clock Generator (MCG) in PLL Engaged External (PEE} mode
         Clock derived from and external crystal 50MHz
         Core clock = 96MHz, BusClock = 48MHz, FlexBus = 48MHz, Flash clock = 24MHz
*/
...
void SystemInit (void) {
  ...
  MCG->C2 = (uint8_t)0x24u;
    ...
    /* SIM_SCGC5: PORTA=1 */
    SIM->SCGC5 |= (uint32_t)0x2A00UL;     /* Enable clock gate for ports to enable pin routing */
    ...
    SIM->SOPT1 = (uint32_t)((SIM->SOPT1 & (uint32_t)~0x00040000UL) | (uint32_t)0x00080000UL); /* System oscillator drives 32 kHz clock for various peripherals */
    ...
    /* MCG_C6: CME0=1 */
    MCG->C6 |= (uint8_t)0x20U;            /* Enable the clock monitor */
    SIM->SCGC4 |= SIM_SCGC4_LLWU_MASK;    /* Enable LLWU */
		MPU->CESR   = 0x00;
#endif /* (CLOCK_SETUP == 3) */
