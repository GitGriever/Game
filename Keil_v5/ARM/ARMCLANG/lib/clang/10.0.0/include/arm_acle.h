/* Modifications copyright (C) 2019 Arm Limited (or its affiliates). All rights reserved. */
...
#define __arm_wsrf(sysreg, v) __arm_wsr(sysreg, __bit_cast_to_uint32_from_float(v))
#define __arm_rsrf64(sysreg) __bit_cast_to_double_from_uint64(__arm_rsr64(sysreg))
#define __arm_wsrf64(sysreg, v) __arm_wsr64(sysreg, __bit_cast_to_uint64_from_double(v))
...
#define __arm_mte_ptrdiff(__ptra, __ptrb) __builtin_arm_subp(__ptra, __ptrb)
 ...
 // SDCOMP-45157 FIXME: Upstream when ACLE 3.0 or draft with co-proc intrinsics has been published.
