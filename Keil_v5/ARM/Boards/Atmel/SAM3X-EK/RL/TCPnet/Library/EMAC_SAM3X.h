 ...
 *----------------------------------------------------------------------------
 *      Name:    EMAC_SAM3X.H
 *      Purpose: Atmel SAM3X Ethernet Controller Driver definitions
 *      Rev.:    V5.00
 *----------------------------------------------------------------------------
...
#ifndef __EMAC_SAM3X_H
#define __EMAC_SAM3X_H
...
#define ETH_RX_BUF_MIN_NUM (1536/ETH_RX_BUF_SIZE)
...
/* SAM3X EMAC pin masks */
#define EMAC_PIO_PDR_PIN_MSK  (PIO_PDR_P0 | PIO_PDR_P1 | PIO_PDR_P2 | PIO_PDR_P3 | \
                               PIO_PDR_P4 | PIO_PDR_P5 | PIO_PDR_P6 | PIO_PDR_P7 | \
                               PIO_PDR_P8 | PIO_PDR_P9 )

#define EMAC_PIO_PUDR_PIN_MSK (PIO_PDR_P8 | PIO_PDR_P9)
...
#define EMAC_DESC_OWN       (1U <<  0)  /* Ownership bit (0 == DMA, 1 == CPU */
#define EMAC_DESC_WRAP      (1U <<  1)  /* Wrap - last descriptor in list    */
...
/* PHY IDs */
#define PHY_ID_DM9161       0x0181B8A0  /* DM9161 PHY Identifier             */
