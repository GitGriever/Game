...
void LED_Init (void) {
  ...
  PORTC->PCR[10] = (1UL <<   8);        /* PTC10 is GPIO pin                  */

  /* Switch LEDs off and enable output                                        */
  PTC->PDOR = (led_mask[1] | led_mask[0]);
...
void LED_UnInit(void) {
  PORTC->PCR[0] = 0;                   /* PTC9 is at reset state              */
  PORTC->PCR[1] = 0;                   /* PTC10 is at reset state             */
}
