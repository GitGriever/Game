 ...
 * $Revision:    V1.00
 *  
 * Project:      Flash Programming Functions for Toshiba TMPM36xFx Flash
 * --------------------------------------------------------------------------- */
...
#define MACRO_ADD1(add) ((adr >= 0x100000) ? (0x105400) : (0x005400))  
#define MACRO_ADD2(add) ((adr >= 0x100000) ? (0x10AA00) : (0x00AA00))  
