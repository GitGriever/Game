 ...
 *      RL-ARM - FlashFS
 *----------------------------------------------------------------------------
 *      Name:    FSMC_STM32F4xx.h
 *      Purpose: Flexible static memory controller Driver for ST STM32F4xx
 *      Rev.:    V4.70
 *----------------------------------------------------------------------------
 ...
 *---------------------------------------------------------------------------*/
/* Timing configured for HCLK @ 168MHz */
#define NAND_CO_HIZ_TIME      (0x01 << 24) 
#define NAND_CO_HOLD_TIME     (0x05 << 16)
#define NAND_CO_WAIT_TIME     (0x05 <<  8)
#define NAND_CO_SETUP_TIME    (0x01 <<  0)

#define NAND_AT_HIZ_TIME      (0x01 << 24)
#define NAND_AT_HOLD_TIME     (0x05 << 16)
#define NAND_AT_WAIT_TIME     (0x05 <<  8)
