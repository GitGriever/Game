 ...
 * $Revision:    V1.00
 *  
 * Project:      Flash Programming Functions for Toshiba TMPM330Fx Flash
 * --------------------------------------------------------------------------- */
...
#define FLCS     (*((volatile unsigned long  *)0x40040520))
...
int EraseChip (void) {
  ...
  while ((FLCS & FLCS_RDY) != FLCS_RDY);       // Wait until completed
