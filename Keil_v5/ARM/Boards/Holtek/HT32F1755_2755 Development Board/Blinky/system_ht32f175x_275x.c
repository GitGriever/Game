/**************************************************************************//**
 * @file    HT32F175x_275x/system_ht32f175x_275x.c
 ...
 *
 * @note
 * Copyright (C) 2012 Holtek Semiconductor Inc. All rights reserved.
 *
 * @par
...
/** @addtogroup HT32F175x_275x_System_Private_Includes
  * @{
  */
...
/** @addtogroup HT32F175x_275x_System_Private_TypesDefinitions
  * @{
  */
...
/** @addtogroup HT32F175x_275x_System_Private_Defines
  * @{
  */
/*
...
/*--------------------- Clock Configuration ----------------------------------
//
//  <h> HT32F175x/275x Clock Configuration
...
//
//      <e9>   Dcode cache Enable
//                <i> Default Dcode cache = DISABLE
//      </e>
//
//      <e10>   Icode cache Enable
...
#else
  #define CKCU_GCFGR    (*(vu32 *)(HT_CKCU_BASE  + 0x000))   /*!< global clock configuration register       */
  #define CKCU_GCCR     (*(vu32 *)(HT_CKCU_BASE  + 0x004))   /*!< global clock control register             */
  #define CKCU_GCSR     (*(vu32 *)(HT_CKCU_BASE  + 0x008))   /*!< global clock status register              */
  #define CKCU_PLLCFGR  (*(vu32 *)(HT_CKCU_BASE  + 0x018))   /*!< PLL configuration register                */
  #define CKCU_AHBCFGR  (*(vu32 *)(HT_CKCU_BASE  + 0x020))   /*!< AHB configuration register                */
  #define CKCU_CKST     (*(vu32 *)(HT_CKCU_BASE  + 0x034))   /*!< Clock Source Status register              */
  #define CKCU_LPCR     (*(vu32 *)(HT_CKCU_BASE  + 0x300))   /*!< Low Power Control Register                */
  #define FLASH_CFCR    (*(vu32 *)(HT_FLASH_BASE + 0x200))   /*!< flash pre-fetch control register          */
#endif
...
/** @addtogroup HT32F175x_275x_System_Private_Macros
  * @{
  */
...
/** @addtogroup HT32F175x_275x_System_Private_Variables
  * @{
  */
...
/** @addtogroup HT32F175x_275x_System_Private_FunctionPrototypes
  * @{
  */
...
/** @addtogroup HT32F175x_275x_System_Private_Functions
  * @{
  */
...
void SystemInit (void)
{
  ...
  /**
   * @brief Cache & Pre-fetch buffer configuration
   */
#if (DCACHE_ENABLE == 1)
...
/******************* (C) COPYRIGHT 2012 Holtek Semiconductor Inc. *****END OF FILE***                       */
