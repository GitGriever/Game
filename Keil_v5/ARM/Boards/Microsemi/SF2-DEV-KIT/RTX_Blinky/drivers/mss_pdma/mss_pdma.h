 ...
 *
 * SVN $Revision: 4530 $
 * SVN $Date: 2012-08-22 16:13:38 +0100 (Wed, 22 Aug 2012) $
 */
/*=========================================================================*//**
  @mainpage G4Main MSS GPIO Bare Metal Driver.

  @section intro_sec Introduction
  The G4Main Microcontroller Subsystem (MSS) includes an 8 channel
  ...
  The MSS PDMA driver uses the G4Main "Cortex Microcontroler Software
  Interface Standard - Peripheral Access Layer" (CMSIS-PAL) to access MSS hardware
  registers. You must ensure that the G4Main CMSIS-PAL is either included
  in the software toolchain used to build your project or is included in your
  project. The most up-to-date G4Main CMSIS-PAL files can be obtained using
...
typedef enum __pdma_src_dest
{
    ...
    PDMA_TO_CAN,
    PDMA_FROM_CAN,
    PDMA_FROM_2ND_FPGA_1,
    PDMA_TO_2ND_FPGA_1,
    PDMA_FROM_2ND_FPGA_0,
    PDMA_TO_2ND_FPGA_0,
    PDMA_FROM_COMBLK,
    PDMA_TO_COMBLK,
    PDMA_MEM_TO_MEM
