 ...
 * $Revision:    V1.00
 *  
 * Project:      Flash Programming Functions for Toshiba TMPM46x Flashes
 * --------------------------------------------------------------------------- */
...
#define PAGE_SIZE    4096      // Page Size for TMPM46x but data is written in junks of 4 Words


// Watchdog Timer Registers
#define WD_BASE          0x402F2000ul    // Watchdog Register Base Address
#define WDMOD            (*((volatile unsigned long  *)(WD_BASE + 0x000)))
#define WDCR             (*((volatile unsigned long  *)(WD_BASE + 0x004)))

// Flash Control Register
#define FC_BASE          0x5DFF0000ul    // Flash Control Register Base Address
#define FCPSR0           (*((volatile unsigned long  *)(FC_BASE + 0x020)))
#define FCPSR0_RDY       (1ul << 0)

#define FCAREASEL        (*((volatile unsigned long  *)(FC_BASE + 0x140)))
