 ...
 *----------------------------------------------------------------------------
 *      Name:    usbreg.h
 *      Purpose: Hardware Layer Definitions for NXP LPC13xx
 *----------------------------------------------------------------------------
...
#define EP0_INT             (0x1<<1)         /* EP0 OUT interrupt */
#define EP1_INT             (0x1<<2)         /* EP0 IN  interrupt */
#define EP2_INT             (0x1<<3)         /* EP1 OUT interrupt */
#define EP3_INT             (0x1<<4)         /* EP1 IN  interrupt */
#define EP4_INT             (0x1<<5)         /* EP2 OUT interrupt */
#define EP5_INT             (0x1<<6)         /* EP2 IN  interrupt */
#define EP6_INT             (0x1<<7)         /* EP3 OUT interrupt */
#define EP7_INT             (0x1<<8)         /* EP3 IN  interrupt */
#define EP_INT              (EP0_INT | EP1_INT | EP2_INT | EP3_INT | \
                             EP4_INT | EP5_INT | EP6_INT | EP7_INT  )
