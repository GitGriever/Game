 ...
 * $Revision:    V1.00
 *  
 * Project:      Flash Programming Functions for Toshiba TMPM39x Flash
 * --------------------------------------------------------------------------- */
...
#define WDMOD    (*((volatile unsigned char  *)0x400F0080))
#define WDCR     (*((volatile unsigned char  *)0x400F0084))
