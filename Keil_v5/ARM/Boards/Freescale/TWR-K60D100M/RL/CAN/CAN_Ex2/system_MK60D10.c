...
**     - rev. 1.0 (2012-01-03)
**         Initial version
**         Added CLOCK_SETUP case '3' (By ARM) 
** ###################################################################
*/
...
void SystemInit (void) {
  ...
  MCG->C2 = (uint8_t)0x24u;
#elif (CLOCK_SETUP == 3)
  /* SIM->CLKDIV1: OUTDIV1=0, OUTDIV2=1, OUTDIV3=1, OUTDIV4=3 */
  ...
  /* MCG->C4: DMX32=0,DRST_DRS=0 */
  MCG->C4 &= (uint8_t)~(uint8_t)0xE0u;
  /* MCG->C5: ??=0,PLLCLKEN=0,PLLSTEN=0,PRDIV=0x18(25) */
  ...
  /* MCG->C1: CLKS=2,FRDIV=5,IREFS=0,IRCLKEN=1,IREFSTEN=0 */
  MCG->C1 = (uint8_t)0xAAu;
  /* MCG->C6: LOLIE=0,PLLS=1,CME=0,VDIV=0x18(48) */
  MCG->C6 = (uint8_t)(0x40u | 0x18u);
  /* Switch to PEE Mode */
