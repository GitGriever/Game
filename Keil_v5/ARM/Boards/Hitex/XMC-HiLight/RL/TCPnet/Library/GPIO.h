...
// and drivestrength is WEAK, MEDIUM or STRONG
//
...
#define SET_P4_8       PORT4->OMR = 0x00000100
#define SET_P4_9       PORT4->OMR = 0x00000200
#define SET_P4_10       PORT4->OMR = 0x00000400
#define SET_P4_11       PORT4->OMR = 0x00000800
#define SET_P4_12       PORT4->OMR = 0x00001000
#define SET_P4_13       PORT4->OMR = 0x00002000
#define SET_P4_14       PORT4->OMR = 0x00004000
#define SET_P4_15       PORT4->OMR = 0x00008000
...
#define RESET_P4_8       PORT4->OMR = 0x01000000
#define RESET_P4_9       PORT4->OMR = 0x02000000
#define RESET_P4_10       PORT4->OMR = 0x04000000
#define RESET_P4_11       PORT4->OMR= 0x08000000
#define RESET_P4_12       PORT4->OMR = 0x10000000
#define RESET_P4_13       PORT4->OMR = 0x20000000
#define RESET_P4_14       PORT4->OMR = 0x40000000
#define RESET_P4_15       PORT4->OMR = 0x80000000
...
#define TOGGLE_P4_8       PORT4->OMR = 0x01000100
#define TOGGLE_P4_9       PORT4->OMR = 0x02000200
#define TOGGLE_P4_10       PORT4->OMR = 0x04000400
#define TOGGLE_P4_11       PORT4->OMR = 0x08000800
#define TOGGLE_P4_12       PORT4->OMR = 0x10001000
#define TOGGLE_P4_13       PORT4->OMR = 0x20002000
#define TOGGLE_P4_14       PORT4->OMR = 0x40004000
#define TOGGLE_P4_15       PORT4->OMR = 0x80008000
...
#define Control_P4_8(Mode, DriveStrength)       PORT4->IOCR8 = (PORT4->IOCR8 & ~0x000000F8) | (Mode << 3); PORT4->PDR1 = (PORT4->PDR1 & ~0x00000007) | (DriveStrength)
#define Control_P4_9(Mode, DriveStrength)       PORT4->IOCR8 = (PORT4->IOCR8 & ~0x0000F800) | (Mode << 11); PORT4->PDR1 = (PORT4->PDR1 & ~0x00000070) | (DriveStrength << 4)
#define Control_P4_10(Mode, DriveStrength)      PORT4->IOCR8 = (PORT4->IOCR8 & ~0x00F80000) | (Mode << 19); PORT4->PDR1 = (PORT4->PDR1 & ~0x00000700) | (DriveStrength << 8)
#define Control_P4_11(Mode, DriveStrength)      PORT4->IOCR8 = (PORT4->IOCR8 & ~0xF8000000) | (Mode << 27); PORT4->PDR1 = (PORT4->PDR1 & ~0x00007000) | (DriveStrength << 12)
#define Control_P4_12(Mode, DriveStrength)      PORT4->IOCR12 = (PORT4->IOCR12 & ~0x000000F8) | (Mode << 3); PORT4->PDR1 = (PORT4->PDR1 & ~0x00070000) | (DriveStrength << 16)
#define Control_P4_13(Mode, DriveStrength)      PORT4->IOCR12 = (PORT4->IOCR12 & ~0x0000F800) | (Mode << 11); PORT4->PDR1 = (PORT4->PDR1 & ~0x00700000) | (DriveStrength << 20)
#define Control_P4_14(Mode, DriveStrength)      PORT4->IOCR12 = (PORT4->IOCR12 & ~0x00F80000) | (Mode << 19); PORT4->PDR1 = (PORT4->PDR1 & ~0x07000000) | (DriveStrength << 24)
#define Control_P4_15(Mode, DriveStrength)      PORT4->IOCR12 = (PORT4->IOCR12 & ~0xF8000000) | (Mode << 27); PORT4->PDR1 = (PORT4->PDR1 & ~0x70000000) | (DriveStrength << 28)
