 ...
 * $Revision:    V1.00
 *  
 * Project:      Flash Device Description for Toshiba TMPM330Fx Flash
 * --------------------------------------------------------------------------- */
...
struct FlashDevice const FlashDevice  =  {
   ...
   "TMPM33xFDx 512kB Flash",   // Device Name 
   ONCHIP,                     // Device Type
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "TMPM33xFYx 256kB Flash",   // Device Name 
   ONCHIP,                     // Device Type
   0x00000000,                 // Device Start Address
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "TMPM33xFWx 128kB Flash",   // Device Name 
   ONCHIP,                     // Device Type
   0x00000000,                 // Device Start Address
