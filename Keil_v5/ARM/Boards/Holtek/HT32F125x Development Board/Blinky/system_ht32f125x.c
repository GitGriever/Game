 ...
 */
  ...
  #define CKCU_APBCCR0  HT_CKCU->APBCCR0                     /*!< APB clock control register                */
  #define CKCU_LPCR     HT_CKCU->LPCR                        /*!< low power control register                */
  #define FLASH_CFCR    HT_FLASH->CFCR                       /*!< flash pre-fetch control register          */
  #define GPIOA_INER    HT_GPIOA->INER                       /*!< PA input function enable control register */
#else
  ...
  #define CKCU_APBCCR0  (*(vu32 *)(HT_CKCU_BASE  + 0x02C))   /*!< APB clock control register                */
  ...
  #define GPIOA_INER    (*(vu32 *)(HT_GPIOA_BASE + 0x004))   /*!< PA input function enable control register */
#endif
...
void SystemInit (void)
{
  ...
  SetBit_BB((u32)&(CKCU_APBCCR0), 16);                /*!< enable GPIO A clock                              */
  ResetBit_BB((u32)&(GPIOA_INER), 10);                /*!< disable PA.10 input function                     */
...
void SystemCoreClockUpdate(void)
{
  ...
  u32 SystemCoreClockSrc = CKCU_GCCR & 3UL;
