 ...
 * $Revision:    V1.00
 *  
 * Project:      Flash Programming Functions for ATSAMD20
 * --------------------------------------------------------------------------- */
...
typedef struct {
  vu32 WPCLR;           /* offset: 0x000 (R/W 32) Write Protect Clear Register */
  vu32 WPSET;           /* offset: 0x004 (R/W 32) Write Protect Set Register */
} PAC_TypeDef;
...
/* ---- SAM D20 ------------------------------------------------------------------*/
#if defined ATSAMD20_256 || defined ATSAMD20_128 || defined ATSAMD20_64 || defined ATSAMD20_32 || defined ATSAMD20_16
  #define PAC0_BASE            0x40000000
  #define PAC1_BASE            0x41000000
  #define NVMCTRL_BASE         0x41004000        /* SAMD20                     */
#endif

#if defined ATSAMD20_256
  #define FLASH_SIZE           0x40000
#endif

#if defined ATSAMD20_128
  #define FLASH_SIZE           0x20000
#endif

#if defined ATSAMD20_64
  #define FLASH_SIZE           0x10000
#endif

#if defined ATSAMD20_32
  #define FLASH_SIZE           0x08000
#endif

#if defined ATSAMD20_16
  #define FLASH_SIZE           0x04000
#endif


#define PAC0           ((      PAC_TypeDef *)   PAC0_BASE)
#define PAC1           ((      PAC_TypeDef *)   PAC1_BASE)
#define NVMCTRL        ((  NVMCTRL_TypeDef *)   NVMCTRL_BASE)

#define FLASH_PAGE_SIZE         64                          /* Page size is 64 Byte for all devices */
#define FLASH_REGION_SIZE      (FLASH_SIZE / 16)            /* Falsh consists of 16 regions */
...
/* 
  PAC0->WPCLR = (1ul << 2);           // disable SYSCTRL Write Protection
 ...
 */
  ...
  if (PAC1->WPCLR & (1ul << 2)) {
    PAC1->WPCLR = (1ul << 2);         /* disable NVMCTRL Write Protection */
  }
