 ...
 * 
 * G4Main microcontroller subsystem Peripheral DMA bare metal software
 * driver implementation.
 *
 * SVN $Revision: 3148 $
 * SVN $Date: 2010-11-19 16:16:36 +0000 (Fri, 19 Nov 2010) $
 */
#include "mss_pdma.h"
...
const uint32_t src_dest_to_ctrl_reg_lut[] =
{
    ...
    CHANNEL_N_CTRL_PDMA_MASK | ( (uint32_t)12 << CHANNEL_N_PERIPH_SELECT_SHIFT),                            /* PDMA_FROM_2ND_FPGA_1 */
    CHANNEL_N_CTRL_PDMA_MASK | ( (uint32_t)12 << CHANNEL_N_PERIPH_SELECT_SHIFT) | CHANNEL_N_DIRECTION_MASK, /* PDMA_TO_2ND_FPGA_1 */
    CHANNEL_N_CTRL_PDMA_MASK | ( (uint32_t)13 << CHANNEL_N_PERIPH_SELECT_SHIFT),                            /* PDMA_FROM_2ND_FPGA_0 */
    CHANNEL_N_CTRL_PDMA_MASK | ( (uint32_t)13 << CHANNEL_N_PERIPH_SELECT_SHIFT) | CHANNEL_N_DIRECTION_MASK, /* PDMA_TO_2ND_FPGA_0 */
