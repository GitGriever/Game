...
;/*                                                                                                         */
;/* Copyright (c) 2012 by Holtek Semiconductor Inc.                                                         */
;/* All rights reserved.                                                                                    */
;/*                                                                                                         */
;/*-----------------------------------------------------------------------------------------------------------
;  File Name        : startup_ht32f175x_275x.s
;  Version          : V1.0
;  Date[mm/dd/yyyy] : 04/10/2012
...
;//   <o> Stack Size (in Bytes) <0-65536:8>
;// </h>
Stack_Size          EQU     512
...
;//   <o>  Heap Size (in Bytes) <0-65536:8>
;// </h>
Heap_Size           EQU     0
...
__Vectors           DCD  __initial_sp                       ; Top address of Stack
                    ...
                    DCD  ADC_IRQHandler
                    DCD  0
                    DCD  MCTMBRK_IRQHandler
                    DCD  MCTMUP_IRQHandler
                    DCD  MCTMTR_IRQHandler
                    DCD  MCTMCC_IRQHandler
                    DCD  0
                    DCD  0
                    DCD  0
                    DCD  0
                    ...
                    DCD  PDMA_CH8_IRQHandler
                    DCD  PDMA_CH9_IRQHandler
                    DCD  PDMA_CH10_IRQHandler
                    DCD  PDMA_CH11_IRQHandler
                    DCD  CSIF_IRQHandler
...
Default_Handler     PROC
                    ...
                    EXPORT  MCTMBRK_IRQHandler              [WEAK]
                    EXPORT  MCTMUP_IRQHandler               [WEAK]
                    EXPORT  MCTMTR_IRQHandler               [WEAK]
                    EXPORT  MCTMCC_IRQHandler               [WEAK]
