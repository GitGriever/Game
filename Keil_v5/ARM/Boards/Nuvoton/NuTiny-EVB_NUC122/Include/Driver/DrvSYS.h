...
typedef enum 
{
    E_SYS_XTL12M,       /* External 4 ~ 24 MHz Crystal     */
    E_SYS_XTL32K,       /* External 32.768 KHz crystal     */
    E_SYS_OSC22M,       /* Internal 22.1184 MHz Oscillator */
    E_SYS_OSC10K,       /* Internal 10 KHz Oscillator      */
    E_SYS_PLL           /* PLL clock                       */
...
/*---------------------------------------------------------------------------------------------------------*/
/* Define DrvSYS functions prototype                                                                       */
/*---------------------------------------------------------------------------------------------------------*/
