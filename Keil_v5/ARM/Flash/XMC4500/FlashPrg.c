 ...
 * $Revision:    V1.00
 *  
 * Project:      Flash Programming Functions for Infineon XMC4500 Flash
 * --------------------------------------------------------------------------- */
...
#if defined XMC4500_1024 || defined XMC4500c_1024
  #define FLASH_SIZE           (0x00100000UL)
#endif
#if defined XMC4500_768  || defined XMC4500c_768
  #define FLASH_SIZE           (0x000C0000UL)
#endif
#if defined XMC4500_512  || defined XMC4500c_512
