...
void LED_init(void) {
  ...
  PORTB->PCR[6]  = (1UL <<  8);                      /* Pin PTB6  is GPIO */
  PORTB->PCR[7]  = (1UL <<  8);                      /* Pin PTB7  is GPIO */
  PORTB->PCR[10] = (1UL <<  8);                      /* Pin PTD10 is GPIO */
 ...
 *----------------------------------------------------------------------------*/
void LEDRed_On (void) {
  FPTB->PSOR   = led_mask[LED_BLUE];   /* Blue LED Off*/
...
void LEDGreen_On (void) {
  ...
  FPTB->PSOR   = led_mask[LED_GREEN];  /* Blue LED Off*/
  FPTB->PCOR   = led_mask[LED_BLUE];   /* Green LED On*/
}
...
void LEDBlue_On (void) {
  FPTB->PSOR   = led_mask[LED_BLUE];   /* Green LED Off*/
  FPTB->PSOR   = led_mask[LED_RED];    /* Red LED Off*/
  FPTB->PCOR   = led_mask[LED_GREEN];  /* Blue LED On*/
}
