 ...
 * $Revision:    V1.00
 *  
 * Project:      Flash Device Description for Toshiba TMPM341Fx Flash
 * --------------------------------------------------------------------------- */
...
struct FlashDevice const FlashDevice  =  {
   ...
   "TMPM341 256kB Flash",      // Device Name 
   ONCHIP,                     // Device Type
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "TMPM341 512kB Flash",      // Device Name 
   ONCHIP,                     // Device Type
   0x00000000,                 // Device Start Address
...
#ifdef TMPM341_BE_512
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "TMPM341 BE 512kB Flash",   // Device Name 
   ONCHIP,                     // Device Type
   0x00000000,                 // Device Start Address
   0x00080000,                 // Device Size (512kB)
   512,                        // Programming Page Size
