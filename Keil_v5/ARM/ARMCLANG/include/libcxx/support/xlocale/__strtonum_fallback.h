...
inline _LIBCPP_INLINE_VISIBILITY _LIBCPP_FLOAT_ABI float strtof_l(const char *nptr,
                                            char **endptr, locale_t) {
  return ::strtof(nptr, endptr);
}

inline _LIBCPP_INLINE_VISIBILITY _LIBCPP_FLOAT_ABI double strtod_l(const char *nptr,
                                                   char **endptr, locale_t) {
  return ::strtod(nptr, endptr);
}

#if defined(__LIBCPP_HAVE_LONGDOUBLE) /* SDCOMP-28981 */
inline _LIBCPP_INLINE_VISIBILITY _LIBCPP_FLOAT_ABI long double strtold_l(const char *nptr,
                                                   char **endptr, locale_t) {
