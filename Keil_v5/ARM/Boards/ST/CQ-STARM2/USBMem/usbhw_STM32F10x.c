...
void USB_Init (void) {
  ...
  GPIOD->BSRR =  0x0200;                    /* set PD9 */
  GPIOD->CRH &= ~0x000000F0;                /* clear port PD9 */
  GPIOD->CRH |=  0x00000030;                /* PD9 General purpose output push-pull, max speed 50 MHz */
}
