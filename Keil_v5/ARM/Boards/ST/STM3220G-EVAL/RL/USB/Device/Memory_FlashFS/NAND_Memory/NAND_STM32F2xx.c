...
U32 FSMC_UnInit (U32 cs) {
  switch (cs) {
    case FSMC_NE1:
      ...
      break;
    case FSMC_NE2: /* No hardware */
    case FSMC_NE3: /* No hardware */
    case FSMC_NE4: /* No hardware */
    /* BANK 2 */
    /*  ...   */
    /* BANK 3 */
    /*  ...   */
