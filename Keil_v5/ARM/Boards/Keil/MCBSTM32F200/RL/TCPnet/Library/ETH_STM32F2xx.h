 ...
 *      RL-ARM - TCPnet
 *----------------------------------------------------------------------------
 *      Name:    ETH_STM32F2XX.H
 *      Purpose: ST STM32F2xx Ethernet Controller Driver definitions
 *      Rev.:    V4.60
 *----------------------------------------------------------------------------
...
#ifndef __ETH_STM32F2XX_H
#define __ETH_STM32F2XX_H
...
/* Connection setting */
#define PHY_CON_SET_100M    0x00000001  /* PHY connected in 100Mb/s mode     */
#define PHY_CON_SET_FULLD   0x00000002  /* PHY full-duplex mode enabled      */
...
/* ST802RT1x PHY Registers */
#define PHY_REG_CNTRL       0x00        /* Control register                  */
#define PHY_REG_STATS       0x01        /* Status register                   */
#define PHY_REG_PHYID1      0x02        /* PHY identifier register Hi        */
#define PHY_REG_PHYID2      0x03        /* PHY identifier register Lo        */
#define PHY_REG_LDADV       0x04        /* Auto-negotiation advertisement reg*/
#define PHY_REG_LPADV       0x05        /* Auto-neg. link partner ability reg*/
#define PHY_REG_ANEGX       0x06        /* Auto-neg. expansion register      */
#define PHY_REG_LDNPG       0x07        /* Auto-neg. next page transmit reg  */
#define PHY_REG_LPNPG       0x08        /* Auto-neg. link partner Rx next pag*/

/* ST802RT1x PHY Extended Registers */
#define PHY_REG_XCNTL       0x10        /* RMII-TEST control register        */
#define PHY_REG_XSTAT       0x11        /* Receiver conf. info and int. statu*/
#define PHY_REG_XRCNT       0x12        /* Receiver event interrupts register*/
#define PHY_REG_XCCNT       0x13        /* 100Base-TX control register       */
#define PHY_REG_XDCNT       0x14        /* Receiver mode control register    */
#define PHY_REG_AUXCS       0x18        /* Auxiliary control register        */
#define PHY_REG_AUXSS       0x19        /* Auxiliary status register         */
#define PHY_REG_AUXM2       0x1B        /* Auxiliary mode 2 register         */
#define PHY_REG_TSTAT       0x1C        /* 10Base-T error and general status */
#define PHY_REG_AMPHY       0x1E        /* Auxiliary PHY register            */
