 ...
 *      RL-ARM - FlashFS
 *-----------------------------------------------------------------------------
 *      Name:    SDIO_STM32F2xx.h
 *      Purpose: SD/SDIO MMC Interface Driver for ST STM32F2xx Definitions
 *      Rev.:    V4.70
 *-----------------------------------------------------------------------------
...
#ifndef __SDIO_STM32F2XX_H
#define __SDIO_STM32F2XX_H

/* SD Card communication speed */
#define SD_CLK              48000000
