...
#if   (defined ( __CC_ARM ))
uint8_t Bias_Current __attribute__((at(0x08080000)));            /* __TEST   KEIL */
...
#if   (defined ( __CC_ARM ))
bool Auto_test      __attribute__((at(0x08080004)));             /* __TEST   KEIL */
#elif (defined (__ICCARM__))
...
/**
  * @brief  Display touch sensing button value
  * @caller main
  * @param None
  * @retval None
  */
