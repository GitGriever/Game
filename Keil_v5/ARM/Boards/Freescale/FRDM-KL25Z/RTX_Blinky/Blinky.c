 ...
 *      Copyright (c) 2006-2012 KEIL - An ARM Company. All rights reserved.
 *---------------------------------------------------------------------------*/
...
void LEDRed_On (void) {
  ...
  FPTD->PSOR   = led_mask[LED_GREEN];  /* Green LED Off*/
...
void LEDGreen_On (void) {
  ...
  FPTD->PSOR   = led_mask[LED_GREEN];  /* Blue LED Off*/
...
void LEDBlue_On (void) {
  ...
  FPTB->PSOR   = led_mask[LED_RED];    /* Red LED Off*/
  FPTD->PCOR   = led_mask[LED_GREEN];  /* Blue LED On*/
}
