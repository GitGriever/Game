/*-----------------------------------------------------------------------------
 * Name:    I2C.c
 * Purpose: I2C low level routines fot LPC178x
 * Note(s):
 *-----------------------------------------------------------------------------
...
/* LPC178x Register Bits Definitions */
...
uint32_t I2C_Init (void) {
  ...
  /* Clock rate 40kHz @ APB1 Clock */
  LPC_I2C0->SCLH = I2C_PERIPH_CLK / 40000;
  LPC_I2C0->SCLL = I2C_PERIPH_CLK / 40000;
