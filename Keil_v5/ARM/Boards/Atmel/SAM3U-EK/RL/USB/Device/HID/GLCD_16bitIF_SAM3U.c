/******************************************************************************/
/* GLCD_16bitIF_SAM3U.c: ATSAM3U-EK low level Graphic LCD (240x320 pixels)    */
...
/*--------------------------- CS2 --------------------------------------------*/
  ...
  SMC->SMC_CS_NUMBER[2].SMC_PULSE = 0
                                 ...
                                 | (SMC_PULSE_NCS_WR_PULSE(18))
                                 | (SMC_PULSE_NRD_PULSE(5)    )
                                 | (SMC_PULSE_NCS_RD_PULSE(18))
                                 ;

  SMC->SMC_CS_NUMBER[2].SMC_CYCLE = 0
                                 | (SMC_CYCLE_NWE_CYCLE(22))
