 ...
 *
 * SVN $Revision: 4751 $
 * SVN $Date: 2012-10-16 15:14:50 +0100 (Tue, 16 Oct 2012) $
 */
...
#define FLASH_FREEZE_RESPONSE_PRE_REVC_HACK
    ...
    switch(g_comblk_state)
    {
        ...
        case COMBLK_WAIT_RESPONSE:
            if(is_command)
            {
                ...
                {
#ifdef FLASH_FREEZE_RESPONSE_PRE_REVC_HACK
                    g_comblk_p_response[0] = rxed_opcode;
                    complete_request(1u);
#else
                    /*
