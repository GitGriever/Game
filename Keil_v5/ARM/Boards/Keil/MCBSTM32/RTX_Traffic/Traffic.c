...
#define RED     0                     /* LED:      RED    lamp output        */
#define YELLOW  1                     /* LED:      YELLOW lamp output        */
#define GREEN   2                     /* LED:      GREEN  lamp output        */
#define STOP    4                     /* LED:      STOP   lamp output        */
#define WALK    5                     /* LED:      WALK   lamp output        */

#define key     0x002000              /* I/O Pin:  self-service key input    */
...
__task void keyread (void) {
  while (1) {                                 /* endless loop                */
    if ((GPIOC->IDR & key) == 0) {            /* if key pressed              */
