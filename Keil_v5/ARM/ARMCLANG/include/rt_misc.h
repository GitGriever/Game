...
#if !defined(__ARM_64BIT_STATE) && !defined(__TARGET_ARCH_AARCH64)
/*
 * Resolve a value that was relocated by R_ARM_TARGET1/2 in a platform-specific
 * manner. `ptr' is a pointer to the relocated word. Return value is the
 * absolute address of the object pointed by the original R_ARM_TARGET1/2
 * relocation.
 */
uintptr_t __ARM_resolve_target1(const uintptr_t * /*ptr*/);
uintptr_t __ARM_resolve_target2(const uintptr_t * /*ptr*/);
#endif
