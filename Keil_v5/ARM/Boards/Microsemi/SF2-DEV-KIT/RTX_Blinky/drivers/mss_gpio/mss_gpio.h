...
/*=========================================================================*//**
  ...
  with the exception of the SmartFusion2 IOMUX configuration. SmartFusion2 allows
  ...
  16 to 31 are routed through IOMUX to the SmartFusion2 device external pins.
  ...
  The MSS GPIO driver uses the SmartFusion2 "Cortex Microcontroler Software
...
/*-------------------------------------------------------------------------*//**
  ...
  Please note that using bit-banding might be a better option than this function
  for performance critical applications where the application code is not
  intended to be ported to a processor other than SmartFusion2. The bit-banding
  equivalent to this function would be: 
