...
/*-------------------------------------------------------------------------*//**
  The MSS_SYS_nrbg_self_test function performs a self test of the non 
  deterministic random bit generator (NRBG).
...
/*-------------------------------------------------------------------------*//**
  The MSS_SYS_nrbg_instantiate function instantiates a NRBG instance.
...
/*-------------------------------------------------------------------------*//**
  ...
  @param drbg_handle
    ...
    been obtained as a result of a call to the MSS_SYS_nrbg_instantiate() function.
...
/*-------------------------------------------------------------------------*//**
  The MSS_SYS_nrbg_reseed function is used to reseed the random bit generator
  ...
  @param drbg_handle
    ...
    a call to the MSS_SYS_nrbg_instantiate() function.
...
/*-------------------------------------------------------------------------*//**
  The MSS_SYS_nrbg_uninstantiate function releases the random bit generator
  identified by the drbg_handle parameter.
  
  @param drbg_handle
    The drbg_handle parameter specifies which random bit generator instance
    will be uninstantiated. The value of drbg_handle will have been obtained as
    a result of a call to the MSS_SYS_nrbg_instantiate() function.
