/*-----------------------------------------------------------------------------
 * Name:    I2C_LPC177x_8x.c
 * Purpose: I2C low level routines for the LPC177x and LPC178x
 * Note(s):
 *-----------------------------------------------------------------------------
...
#define I2C_PERIPH_CLK   60000000
...
/* I2C Protocol State Definitions */

/* LPC177x_8x Register Bits Definitions */
...
uint32_t I2C_Init (void) {
  ...
  /* Configure I2C Pins */
  LPC_IOCON->P0_27 = 1;                      /* P0.27 is I2C0 SDA pin         */
  LPC_IOCON->P0_28 = 1;                      /* P0.28 is I2C0_SCL pin         */

  /* Clock rate 400kHz @ defined peripheral clock */
  LPC_I2C0->SCLH = I2C_PERIPH_CLK / 200000;
  LPC_I2C0->SCLL = I2C_PERIPH_CLK / 200000;
