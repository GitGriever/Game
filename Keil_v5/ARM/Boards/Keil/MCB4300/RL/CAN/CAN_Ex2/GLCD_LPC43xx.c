/*-----------------------------------------------------------------------------
 * Name:    GLCD_LPC43xx.c
 * Purpose: LPC43xx low level Graphic LCD (240x320 pixels) using
...
#define FRAME_BUFFER_ADDR 0x28000000
...
/******************************************************************************/
static uint16_t fb[PHYS_XSZ*PHYS_YSZ]__attribute__((at(FRAME_BUFFER_ADDR)));
