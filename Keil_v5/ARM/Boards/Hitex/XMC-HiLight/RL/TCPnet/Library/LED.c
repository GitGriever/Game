...
#define NUM_LEDS  (3 + 3)               /* Number of LEDs (3 outputs for RGB) */
...
void LED_Init (void) {
  ...
  /* RGB led diode */
  Control_P1_10 (OUTPUT_PP_GP, STRONG);
  Control_P1_11 (OUTPUT_PP_GP, STRONG);
  Control_P1_12 (OUTPUT_PP_GP, STRONG);
  Set (P1_10);
  Set (P1_11);
  Set (P1_12);
}
